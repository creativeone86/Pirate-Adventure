...
- (IBAction)actionButtonPressed:(UIButton *)sender {
    ...
    //check if we die or we win
    
    if (self.character.health <= 0) {
        UIAlertView *alertView = [[UIAlertView alloc] initWithTitle:@"Game Over" message:@"You have died please restart the game!" delegate:nil cancelButtonTitle:@"Ok" otherButtonTitles: nil];
...
-(void)updateButtons
{
    ...
    self.sudButton.hidden = [self tileExistsAtPoint:CGPointMake(self.currentPoint.x, self.currentPoint.y - 1)];
